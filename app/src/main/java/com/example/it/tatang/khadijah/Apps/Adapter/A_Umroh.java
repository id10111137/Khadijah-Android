...
public class A_Umroh extends ArrayAdapter<M_Umroh> {

    private Context context;
    private List<M_Umroh> dataSet = null;
    private ArrayList<M_Umroh> originDataSet = null;
    LayoutInflater inflater;

    public A_Umroh(ArrayList<M_Umroh> data, Context context) {
        super(context, R.layout.activity_umroh_items, data);
        this.dataSet = data;
    ...
    @Override
    public M_Umroh getItem(int position) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        final M_Umroh dataModel = getItem(position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_umroh_items, parent, false);
